...
import { MapPin, ArrowRight, Phone, Clock, Shield, CheckCircle2, Star, Lock } from "lucide-react"
import { Breadcrumbs } from "@/components/seo/breadcrumbs"
import { Button } from "@/components/ui/button"

export const metadata: Metadata = {
  title: "Cerrajero 24 Horas | Servicio Urgente en Toda España | Electricistas 24H",
  description: "Cerrajero profesional 24 horas. Abrimos puertas sin romper, cambio de cerraduras, bombillos de seguridad. Llegamos en 15-30 min. Llama al 900 433 214.",
}

export default async function CerrajeroMainPage() {
  ...
  // Get all published pages for this service
  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-4">
        <Breadcrumbs items={[{ label: "Cerrajero" }]} />
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl lg:text-3xl font-bold mb-6">
              Cerrajero de confianza en toda Espana
            </h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Selecciona tu ciudad para ver informacion especifica de nuestro servicio de cerrajeria en tu zona
          </p>
