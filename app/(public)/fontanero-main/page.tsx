...
import { MapPin, ArrowRight, Phone, Clock, Shield, CheckCircle2, Star, Droplets } from "lucide-react"
import { Breadcrumbs } from "@/components/seo/breadcrumbs"
import { Button } from "@/components/ui/button"

export const metadata: Metadata = {
  title: "Fontanero 24 Horas | Servicio Urgente en Toda España | Electricistas 24H",
  description: "Fontanero profesional 24 horas. Reparacion de fugas, desatascos, instalacion de sanitarios. Llama al 900 433 214.",
}

export default async function FontaneroMainPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-4">
        <Breadcrumbs items={[{ label: "Fontanero" }]} />
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl lg:text-3xl font-bold mb-6">
              Fontanero de confianza en toda Espana
            </h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Selecciona tu ciudad para ver informacion especifica de nuestro servicio de fontaneria en tu zona
          </p>
